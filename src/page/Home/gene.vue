            ...
            <el-col :span="18">
              ...
              <ul class="gene_list">
                ...
                >
                  ...
                  <div
                    class="right_right"
                    style="float:left;margin-left:1.75rem;width:90%;border-bottom:1px solid #eee;padding:20px 0;"
                  >
                    <div
                      class="left_content"
                      style="float:left; overflow: hidden; text-overflow: ellipsis;white-space: nowrap;width:600px;background-color:red;"
                    >
